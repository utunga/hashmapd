...
The aim of this RBM is to be just like the normal RBM except the input layer
is considered to be the 'softmax' probability of a given word
being the next generated. This means its just like the 'normal' RBM except
the activations are softmaxed on the way 'down' from hidden to visible.
"""
